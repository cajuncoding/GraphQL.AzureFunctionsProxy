...
{
    public class GraphQLAzFuncContext : IDisposable
    {
        public FunctionContext FunctionExecutionContext{ get; protected set; }

        public ILogger Logger { get; protected set; }

        public HttpContext HttpContext { get; set; }

        public GraphQLAzFuncContext(FunctionContext functionContext, ILogger logger = null)
        {
            FunctionExecutionContext = functionContext;
            Logger = logger ?? functionContext.GetLogger(nameof(GraphQLAzFuncContext));
        }
